    ...
    function (ui, email, runtime, search, record, http, log, redirect) {
        ...
        function onRequest(context) {
            ...
            if (context.request.method === 'GET') {
                ...
                form.clientScriptFileId = 6045767;
        ...
        function tabsSection() {
            ...
            inlineHtml +=
                '<li role="presentation" class=""><a data-toggle="tab" href="#postcode"><b>BY POSTCODE</b></a></li>';
            inlineHtml +=
                '<li role="presentation" class=""><a data-toggle="tab" href="#salesrep"><b>BY SALES REP</b></a></li>';
            inlineHtml +=
                '<li role="presentation" class=""><a data-toggle="tab" href="#services"><b>BY SERVICES OF INTEREST</b></a></li>';
            ...
            inlineHtml += '<div role="tabpanel" class="tab-pane" id="postcode">';
            inlineHtml += '<figure class="highcharts-figure">';
            inlineHtml += '<div id="container2"></div>';
            inlineHtml += '</figure><br></br>';
            inlineHtml += dataTable('postcode_table');
            inlineHtml += '</div>';

            inlineHtml += '<div role="tabpanel" class="tab-pane" id="salesrep">';

            inlineHtml += '<figure class="highcharts-figure">';
            inlineHtml += '<div id="container3"></div>';
            inlineHtml += '</figure><br></br>';
            inlineHtml += dataTable('salesrep_table');
            inlineHtml += '</div>';

            inlineHtml += '<div role="tabpanel" class="tab-pane" id="services">';
            inlineHtml += '<figure class="highcharts-figure">';
            inlineHtml += '<div id="container4"></div>';
            inlineHtml += '</figure><br></br>';
            inlineHtml += dataTable('services_of_interest');
            inlineHtml += '</div>';
