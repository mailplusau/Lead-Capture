    ...
    function(error, runtime, search, url, record, format, email, currentRecord) {
        ...
        function pageInit() {
            ...
            $(document).on("change", ".zee_dropdown", function(e) {
                var zee = $(this).val();
                $('#hiddenzee').val(zee);
                var url = baseURL + "/app/site/hosting/scriptlet.nl?script=1060&deploy=1&type=nominate";
                url += "&zee=" + zee + "";
            ...
            $(document).on('click', '#sendemail', function(event) {
                ...
                var emailSubject = 'MPEX DROP OFF - ' + subject_entity + ' ' + subject_comp;
        ...
        function onclick_back() {
            var urlVar = baseURL + "/app/site/hosting/scriptlet.nl?script=925&deploy=1";
